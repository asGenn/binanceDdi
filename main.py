...
#gu.getUrl(driver)  
url_list = pd.read_excel("url.xlsx", usecols="A") # Excel dosyasından url'leri oku
...
for index, url in enumerate(url_list["url"][starIndex:],start=starIndex):
    ...
    try:
        ...
        try:
            ...
            indexPriceDecline = soup.find_all('span', class_='index price-decline')
        ...
        try:
            ...
            df.to_excel("veriler5.xlsx", index=False) # DataFrame'i Excel dosyasına kaydet
